package com.example.todoLogBack.controllers.api;
...
public interface CategoryApi {
    ...
    @PatchMapping(value = APP_ROOT + "/categories/update", consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ApiOperation(value = "Category Details", notes = "Returns the list of the categories",
    ...
    @ApiOperation(value = "Todo Details by category ID",
            notes = "Returns the list of the Todo of a selected category", responseContainer = "List<CategoryDto>")
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "List of all categories and Todo for today",
            notes = "Returns the list of the Todo of a selected category", responseContainer = "List<CategoryDto>")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "List of the Todos"),
    })
    ...
    @ApiOperation(value = "Category Details by user ID",
